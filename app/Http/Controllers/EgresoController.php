    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            foreach($detalles as $ep=>$det)
            {
                ...
                ->select('articulos.id','articulos.idcategoria','modelo_contable.nombre','modelo_contable.idCuentaSalidaProductos','modelo_contable.idCuentaSalidaProductos','idCuentaSaldosIniciales','idCuentaDonaciones')
            ...
            if($request->tipo_egreso!='Saldos iniciales'){
                $id_tercero = $egreso->idproveedor;
            }else{
                $id_tercero = -1;
            }
