            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Categorías 2
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input v-if="permisosUser.leer" type="text" v-model="buscar" @keyup.enter="listarCategoria(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
    ...
    export default {
        ...
        methods : {
            listarCategoria (page,buscar,criterio){
                let me=this;
                var url= this.ruta +'/categoria2?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            registrarCategoria(){
                ...
                axios.post(this.ruta +'/categoria2/registrar',{
                    'nombre': this.nombre,
            ...
            actualizarCategoria(){
               if (this.validarCategoria()){
                ...
                axios.put(this.ruta +'/categoria2/actualizar',{
                    'nombre': this.nombre,
                    'descripcion': this.descripcion,
            ...
            desactivarCategoria(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta +'/categoria2/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarCategoria(1,'','nombre');
                        swal(
            ...
            activarCategoria(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta +'/categoria2/activar',{
                        'id': id
                    }).then(function (response) {
                        me.listarCategoria(1,'','nombre');
                        swal(
