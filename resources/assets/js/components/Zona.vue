            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="abrirModal('zona','registrar')" class="btn btn-secondary">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarZona(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listarZona(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="zona in arrayZona" :key="zona.id">
                                    ...
                                    <td>
                                        <button v-if="zona.estado" type="button" @click="abrirModal('zona','actualizar',zona)" class="btn btn-warning btn-sm">
                                        ...
                                        <template v-if="zona.estado">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarZona(zona.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarZona(zona.id)">
