            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="abrirModal('bancos','registrar')" class="btn btn-secondary">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarBancos(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listarBancos(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="banco in arrayBancos" :key="banco.id">
                                    ...
                                    <td>
                                        <button v-if="banco.estado" type="button" @click="abrirModal('bancos','actualizar',banco)" class="btn btn-warning btn-sm">
                                        ...
                                        <template v-if="banco.estado">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarBanco(banco.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarBanco(banco.id)">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-md-11 float-right">
                                            <input type="text" v-model="nombre"  style="width: 96%;" class="form-control float-right">
                                        </div>
                                    </div>
                                </div>
