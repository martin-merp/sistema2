            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button v-if="permisosUser.crear && tipoAccion==0" type="button" @click="mostrarDetalle()" class="btn btn-primary">
                                ...
                                <tbody v-if="permisosUser.leer">
                                    <tr v-for="egreso in arrayEgreso" :key="egreso.id">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" v-if="permisosUser.actualizar && egreso.estado=='Registrado'" class="btn btn-success btn-sm" @click="cerrarEgreso(egreso)">
                                                <i class="fa fa-align-justify"></i>
                                            </button>
                    ...
                    <div class="card-body">
                        <div class="form-group row border">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div>
                                    <select class="form-control" v-model="tipo_egreso">
                        ...
                        <div class="form-group row border">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Precio Und <span style="color:red;" v-show="precio==0">(*)</span></label>
                                    <input disabled type="number" :min="1" step="any" class="form-control" v-model="precio">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarEgreso()">Registrar Egreso</button>
                                <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarEgreso()">Actualizar Egreso</button>
                            </div>
                        </div>
                    </div>
                    </template>
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion1==1" class="btn btn-primary" @click="registrarPersona()">Guardar</button>
                            <button type="button" v-if="tipoAccion1==2" class="btn btn-primary" @click="actualizarPersona()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
