<template>
        <main class="main">
            ...
            <div class="modal fade" tabindex="-1" :class="{'mostrar' : modal}" role="dialog" aria-labelledby="myModalLabel" style="position:fixed !important; display: none;" aria-hidden="true">
                ...
                switch(modelo){
                    case "modulo":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                                console.log('HA INGRESADO A ACTUALIZAR');
                                this.modal=1;
