            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="abrirModal('presentacion','registrar')" class="btn btn-secondary">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarPresentacion(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listarPresentacion(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="presentacion in arrayPresentacion" :key="presentacion.id">
                                    ...
                                    <td>
                                        <button v-if="presentacion.estado" type="button" @click="abrirModal('presentacion','actualizar',presentacion)" class="btn btn-warning btn-sm">
                                        ...
                                        <template v-if="presentacion.estado">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarPresentacion(presentacion.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarPresentacion(presentacion.id)">
